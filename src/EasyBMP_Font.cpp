...
int PrintString(BMP& Image, char* String, int TopLeftX, int TopLeftY, int Height, RGBApixel Color) {
	int CharNumber = 0;
	int StartX = TopLeftX;
...
int PrintLetter(BMP& Image, char Letter, int TopLeftX, int TopLeftY, int Height, RGBApixel Color) {
...
int PrintCopyright(BMP& Image, int TopLeftX, int TopLeftY, int Height, RGBApixel Color) {
	double pi = 3.14159265358979;
