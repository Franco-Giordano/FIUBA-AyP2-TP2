...
public:
	...
	//Post: Crea el monedero que usara el usuario a lo largo de la partida.
	Monedero(unsigned int N, unsigned int M, unsigned int dificultad);

	//Post: devuelve el dinero que el usuario podra gastar en su proximo turno.
	...
	//Pre: recibe el dinero que se sumara al haber del jugador.
	//Post: Suma el dinero obtenido al que el usuario tenia previamente.
